...
},{"react-refresh/runtime":"3FsDI","react-error-overlay":"7i2ML"}],"dldJO":[function(require,module,exports) {
"use strict";
...
module.bundle.HMR_BUNDLE_ID = "27b7dc3ca12a6a66";
...
},{}],"5dUzw":[function(require,module,exports) {
"use strict";
exports.__esModule = true;
var Typewriter_1 = require("./Typewriter");
var typewriter1 = new Typewriter_1["default"](document.querySelector(".whitespace"), {
    loop: true,
    typingSpeed: 10,
    deletingSpeed: 10
});
var typewriter2 = new Typewriter_1["default"](document.querySelector(".inner"), {
    loop: false,
    typingSpeed: 100,
    deletingSpeed: 100
});
typewriter1.typeString("Where do I start?").pauseFor(1000).typeString("\n\nfunctio").deleteChars(7).typeString("const temp").pauseFor(150).deleteAll(10).typeString("Why is this so hard?").pauseFor(1000).typeString("\n\nDoes everyone struggle this much?").pauseFor(1000).typeString("\n\nThere has to be an easier way").pauseFor(1000).deleteAll(10).start();
typewriter2.typeString("Where do I start?").deleteChars(9).typeString("do I start?").typeString("\n\nDoes everyone struggle this much?").start();
var x = 10;
if (x > 10) typewriter2.deleteChars(7);
...
},{}]},["1xC6H","dldJO","5dUzw"], "5dUzw", "parcelRequireecb3")

//# sourceMappingURL=index.a12a6a66.js.map
